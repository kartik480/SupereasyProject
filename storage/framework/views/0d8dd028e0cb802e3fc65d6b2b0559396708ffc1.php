...
<?php $__env->startSection('title', 'SuperDaily - Grocery & Services Delivery'); ?>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="product-card">
                    <div class="product-image">
                        <img src="<?php echo e($product->image_url); ?>" alt="<?php echo e($product->name); ?>" class="img-fluid">
                    ...
                    <div class="product-info">
                        ...
                        <p class="product-description"><?php echo e($product->description); ?></p>
                            <div class="product-price">
                                ...
                                <?php endif; ?>
                                <span class="price-unit"><?php echo e($product->unit); ?></span>
                            </div>
                    </div>
                </div>
            </div>
...
<section class="user-profile-section py-4 bg-light">
    <div class="container">
            ...
            <div class="col-md-8">
                <div class="user-welcome">
                    <h4 class="text-primary mb-1">
                        <i class="fas fa-user-circle me-2"></i>Welcome back, <?php echo e(auth()->user()->name ?: 'User'); ?>!
                    </h4>
        ...
        <?php if(in_array(auth()->user()->role, ['superadmin', 'admin', 'maid'])): ?>
        <div class="row mt-3">
            <div class="col-12">
                <div class="alert alert-info mb-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-md-end mt-2 mt-md-0">
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->role === 'maid'): ?>
                                <a href="<?php echo e(route('maid.dashboard')); ?>" class="btn btn-info btn-sm">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="category-card">
                    <div class="category-image">
                        <img src="<?php echo e($category->image_url); ?>" alt="<?php echo e($category->name); ?>" class="img-fluid">
    ...
    <div class="container position-relative">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-card-professional" data-service-id="<?php echo e($service->id); ?>">
                    <!-- Service Image -->
                    <div class="service-image-wrapper">
                        <img src="<?php echo e($service->image_url); ?>" alt="<?php echo e($service->name); ?>" class="service-main-image">
                        <div class="service-overlay">
                            <div class="service-category-tag">
                                <i class="fas fa-tag me-1"></i><?php echo e($service->category ?? 'Service'); ?>

                            </div>
                            <?php if($service->discount_price): ?>
                            <div class="service-discount-tag">
                                Save ₹<?php echo e(number_format($service->price - $service->discount_price, 0)); ?>
                    ...
                    <div class="service-content-wrapper">
                        ...
                        <h4 class="service-name"><?php echo e($service->name); ?></h4>
                        <p class="service-description-preview"><?php echo e(Str::limit($service->description, 80)); ?></p>
                        ...
                        <div class="service-features-preview">
                            ...
                            ?>
                            <?php $__currentLoopData = array_slice($features, 0, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="feature-item">
                                ...
                                <span>+<?php echo e(count($features) - 2); ?> more</span>
                            </div>
                            <?php endif; ?>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="service-pricing-section">
                            <div class="price-display">
                                <?php if($service->discount_price): ?>
                                    <span class="current-price">₹<?php echo e(number_format($service->discount_price, 0)); ?></span>
                                    <span class="original-price">₹<?php echo e(number_format($service->price, 0)); ?></span>
                                <?php else: ?>
                                    <span class="current-price">₹<?php echo e(number_format($service->price, 0)); ?></span>
                                <?php endif; ?>
                                <span class="price-unit"><?php echo e($service->unit ?? 'per session'); ?></span>
                            </div>
                        ...
                        <div class="service-action-section">
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(route('services.show', $service)); ?>" class="btn btn-book-service">
                                    <i class="fas fa-calendar-plus me-2"></i>
                                    <span>Book Now</span>
                                    <small class="d-block mt-1">Starting at ₹<?php echo e(number_format($service->discount_price ?: $service->price, 0)); ?></small>
                                </a>
                            <?php else: ?>
                            ...
                            <div class="service-quick-info mt-2">
                                <small class="text-muted">
                                    <i class="fas fa-clock me-1"></i><?php echo e($service->duration); ?> • 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\superdaily\resources\views/home.blade.php ENDPATH**/ ?>