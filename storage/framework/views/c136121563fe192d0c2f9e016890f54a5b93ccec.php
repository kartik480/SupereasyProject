...
<?php $__env->startSection('title', 'SuperAdmin Login'); ?>
        ...
        <div class="col-md-6">
            <div class="card shadow-lg border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="<?php echo e(route('superadmin.login')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-center mt-4">
                        ...
                        <a href="<?php echo e(route('superadmin.register.show')); ?>" class="btn btn-outline-danger">
                            <i class="fas fa-user-plus me-1"></i>Create SuperAdmin Account
                        </a>
                    </div>
                    
                    <div class="text-center mt-3">
                        <a href="<?php echo e(route('admin.login.show')); ?>" class="text-muted text-decoration-none me-3">
                            <i class="fas fa-tachometer-alt me-1"></i>Admin Login
                        </a>
                        <a href="<?php echo e(route('home')); ?>" class="text-muted text-decoration-none">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\superdaily\resources\views/auth/superadmin-login.blade.php ENDPATH**/ ?>