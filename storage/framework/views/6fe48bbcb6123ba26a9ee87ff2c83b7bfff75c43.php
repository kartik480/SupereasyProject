...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Panel - SuperDaily'); ?></title>
        ...
        <div class="admin-sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('admin.maids.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.maids.index')); ?>">
        ...
        <div class="admin-main">
            ...
            <div class="admin-header">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h1 class="page-title">
                            <?php echo $__env->yieldContent('page-icon'); ?>
                            <?php echo $__env->yieldContent('page-title', 'Dashboard'); ?>
                        </h1>
                        <p class="page-subtitle"><?php echo $__env->yieldContent('page-subtitle', 'Welcome to your admin dashboard'); ?></p>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\superdaily\resources\views/layouts/admin.blade.php ENDPATH**/ ?>