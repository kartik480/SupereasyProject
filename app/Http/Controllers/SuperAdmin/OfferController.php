...
class OfferController extends Controller
{
    public function index()
    {
        ...
        return view('superadmin.offers.index', compact(
            'offers',
            'totalOffers',
            'activeOffers',
            'expiredOffers',
    ...
    {
        return view('superadmin.offers.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('superadmin.offers.index')
    ...
    {
        return view('superadmin.offers.show', compact('offer'));
    }

    public function edit(Offer $offer)
    {
        return view('superadmin.offers.edit', compact('offer'));
    }
