...
<div class="btn-group">
    <a href="{{ route('admin.maids.show', $maid) }}" class="btn btn-outline-info">
    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.maids.update', $maid) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('admin.maids.show', $maid) }}" class="btn btn-outline-secondary">
