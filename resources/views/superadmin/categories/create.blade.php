...
@section('page-subtitle', 'Add a new product/service category')
            ...
            <div class="card-body">
                <div class="category-preview">
                    <div class="preview-image text-center mb-3">
                        <img id="preview-img" src="https://via.placeholder.com/300x200/6c757d/ffffff?text=Category+Image" 
                             alt="Preview" class="img-fluid rounded">
                    </div>
                    <div class="preview-content">
                        <div class="d-flex align-items-center mb-2">
                            <i id="preview-icon" class="fas fa-tag me-2" style="color: #dc3545;"></i>
                            <h6 id="preview-name" class="mb-0">Category Name</h6>
                        </div>
                        <p id="preview-description" class="text-muted small mb-2">Category description will appear here...</p>
